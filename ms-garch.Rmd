...
，无条件波动率为`r sqrt(306)*sapply(ExtractStateFit(m3),UncVol)[1]`，呈低频波动；
当对数收益率处于第二区制GARCH-std时，无条件波动率`r sqrt(306)*sapply(ExtractStateFit(m3),UncVol)[2]`，
波动幅度有所增加；当对数收益率处于第三区制GARCH-sged时，其无条件波动率达到最高，
为`r sqrt(306) * sapply(ExtractStateFit(m3), UncVol)[3]`，呈高频波动，可见Shibor
对数收益率的波动率有逐渐增大的趋势。以上分析综合说明，对数收益率序列存在
区制的转换，不同区制呈现出不同特征。

### 最优模型解释和意义
作为货币市场的“晴雨表”，Shibor能够有效反映宏观经济的调控作用。若市场层面上资金
紧张，投资者对资金的需求量大于资金的供给量，则Shibor会持续上升，反之下降。如图，
通过对不同时刻所处的不同区制的分析以及波动率的表现特征，可以得到隔夜利率在选取的
时间段内，有如下表现：

在前半部分即2006年-2010年时间段，有较为显著的集群现象，波动较为剧烈。2006年9月7日，
为提高金融机构自主定价能力，中国人民银行开始建立报价制货币市场基准利率(Shibor)。
2007至2008年期间，上海刚刚建立同业拆放市场，政府干预过度，受政府的影响较大，使得
利率的形成机制处于萌芽阶段，经常出现调整，造成时大时小，波动较大。而且，在2008年
期间，有一段时期利率疾速下降，是由于金融危机的爆发使得企业贷款资金需求量下降，从
而商业银行头寸资金需求也随之减小。

在中间阶段即2010-2014年，波动剧烈，有着显著集群的表现。自2010年，央行不断发挥Shibor
在货币市场中的作用，推动Shibor产品的发展，使得市场影响力不断提高，货币市场交易量
大幅度增加。之后，在2013年6月，由于政府对外汇资金以及非法债券交易的严厉管控，使得
银行间流动性受到挤压，加之季节性流动性的需求增加，央行当年并没有及时采取及时措施，
使得Shibor经历了一场剧烈的波动，导致隔夜Shibor飙升。于2013年6月20日，隔夜Shibor利
率创历史新高，为13.444%。

在后半阶段即2014-2018年，趋于平稳，不存在波动很大的情况。这是因为同业拆放市场的机
制逐渐成熟，渐渐完善起来，利率波动表现为显著下降，波动趋于一种平稳的状态。波动率
