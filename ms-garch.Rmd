...
J-B（Jarque-Bera）统计量对收益率数据进行正态性检验，统计量J-B对应的p值为2.2e-16
...
Ljung-Box Q统计量的值为107.12，对应p值为5.551e-16,远小于显著性水平0.05，故收益率序列为非
...
分析。根据R软件分析结果可知P值小于2.2e-16,远小于0.05 ，故拒绝原数据，即认为残差平方序列自相关，残差序
列存在ARCH效应。
